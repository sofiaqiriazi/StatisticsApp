/*
	coverflow class defination,
	For demo version we have added
	static dom.
	
	You can do dynamic element as below.
	
	var coverFlowElement = $('#coverFlow1');
	var coverFlow = new CoverFlow(coverFlowElement);
	
	this keyword in class defination represnt 
...
$(function () {
    ...
    coverflowApp = {
		...
		*/
        ...
        /*
			set default option with callback
		*/
        setDefault: function () {
            this.defaultItem -= 1;
		...
		*/
        init_coverflow: function (elem) {
            /*
				make call to setDefault callback function
			*/
            this.setDefault();
            /*
				add coverflow to passed element.
			*/
            this.coverflowCtrl.coverflow({
                /*
					set item,which is set to 6
            ...
            //if there are more than one dom are defined for coverflow
            // then below code will loop throgh each of them
            this.coverflowImages.each(function (index, value) {
                var current = $(this);
                try {
                    coverflowApp.listContent += "<li class='ui-state-default coverflowItem' data-itemlink='" + (index) + "'>" +
                        current.data('artist') + " - " + current.data('album') + "</li>";
                } catch (e) {}
            });
            ...
            // mousewheel hanlder will create
    ...
    /*
		make a call to class method.
		which will create coverflow.
	*/
